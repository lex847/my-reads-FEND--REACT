...
class Books extends Component {
    ...
    render() {
        ...
        <div className="book-cover" style={{ width: 128, height: 193, backgroundImage: `url( ${ this.props.innards.imageLinks ? this.props.innards.imageLinks.thumbnail : ''})`}}></div> {/*fixed with Udacity Code review 10/21/18*/}
